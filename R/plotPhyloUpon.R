...
#' @description Plot phylogenetic trees exactly like \code{\link{plot.phylo}}, 
...
plotPhyloUpon <- function (x, type = "phylogram", use.edge.length = TRUE, node.pos = NULL, 
  ...
  # ---------------------------------
  # globalVariables(".PlotPhyloEnv")
  lastPP <- get("last_plot.phylo", envir = .PlotPhyloEnv)
  direction <- lastPP$direction
  type <- lastPP$type
  x.lim <- lastPP$x.lim
  
  ## Emmanuel Paradis' code; note comment at lines 311/312!
  ## ------------------------------------------------------
